...
export const Login = () => {
    ...
    return (
        <div className="w-3/4 flex flex-col lg:flex-row p-4 lg:p-8 mx-auto bg-white dark:bg-gray-900 rounded-lg shadow-lg max-h-fit">
            <div
                ...
                <form className="grid grid-cols-1 gap-6 mt-8" onSubmit={handleSubmit}>
                    <div>
                        ...
                        <input
                            ...
                            className="block w-full px-2 py-1 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400"
                            required
                        />
                    </div>
